let resConfig = {
    ...
    prefabArr: ['cardItem', 'landItem', 'monsterItem', 'bossItem', 'throwItem', 'commonItem', 'effectItem', 'damageLabel']
}
...
let lvString = ['初窥门径', '略知一二', '粗通皮毛', '半生不熟', '渐入佳境', '了然于胸', '心领神会', '炉火纯青', '融会贯通',
    '略有小成', '举重若轻', '出类拔萃', '运斤成风', '技冠群雄', '登峰造极', '鬼斧神工', '出神入化', '震古烁今', '绝代宗师', '巧夺天工', '举世无双']
let version = '0.0.1'
